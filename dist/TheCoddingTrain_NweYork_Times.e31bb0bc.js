...
},{"jquery":"node_modules/jquery/dist/jquery.js","moment":"node_modules/moment/moment.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
let endDate = new Date().toJSON().slice(0, 10).replace(/-/g, ''); // Getting data from NYTimes API

const urlNYT = 'https://api.nytimes.com/svc/search/v2/articlesearch.json';
const main = document.querySelector('main');

async function getData() {
  const response = await fetch(`${urlNYT}?q=${query}&begin_date=${beginDate}&end_date=${endDate}&api-key=${apiKey}`, {
    headers: {
  ...
  articles.forEach(article => {
    const articleHtml = `
    <article>
    <img src='${article.multimedia.length > 0 ? 'https://static01.nyt.com/' + article.multimedia[0].url : ''}
    ' >
...
(0, _jquery.default)(function () {
  let start = (0, _moment.default)().subtract(0, 'days');
  let end = (0, _moment.default)();

  function cb(start, end) {
    (0, _jquery.default)('#reportrange span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
  }

  (0, _jquery.default)('#reportrange').daterangepicker({
    startDate: start,
    endDate: end,
    ranges: {
...
function updateSearching() {
  (0, _jquery.default)('#reportrange').on('apply.daterangepicker', function (ev, picker) {
...
updateSearching(); // Cleaning search result
...
},{"jquery":"node_modules/jquery/dist/jquery.js","daterangepicker":"node_modules/daterangepicker/daterangepicker.js","moment":"node_modules/moment/moment.js","@fortawesome/fontawesome-free-webfonts":"node_modules/@fortawesome/fontawesome-free-webfonts/css/fontawesome.css","@fortawesome/fontawesome-free-webfonts/css/fa-solid.css":"node_modules/@fortawesome/fontawesome-free-webfonts/css/fa-solid.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/TheCoddingTrain_NweYork_Times.e31bb0bc.js.map